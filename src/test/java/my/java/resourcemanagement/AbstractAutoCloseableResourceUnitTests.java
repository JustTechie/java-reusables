...
public class AbstractAutoCloseableResourceUnitTests 
{
  @Test
  ...
  @Test (expectedExceptions = RuntimeException.class, expectedExceptionsMessageRegExp = "Exception occurred on close.")
  ...
  // Private methods
  private static class AutoCloseableImpl extends AbstractAutoCloseableResource<String>
  {
    ...
    protected void doClose()
    {
      ...
      {
        throw new RuntimeException("Exception occurred on close.");
      }
